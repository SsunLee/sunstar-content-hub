...
export const ADFIT_PLACEMENTS = Object.freeze({
  ...
  "ko-home-first-desktop": Object.freeze({
    unit: "KAKAO_ADFIT_KO_HOME_FIRST_DESKTOP_UNIT",
    width: "KAKAO_ADFIT_KO_HOME_FIRST_DESKTOP_WIDTH",
    height: "KAKAO_ADFIT_KO_HOME_FIRST_DESKTOP_HEIGHT",
  }),
  "ko-home-first-mobile": Object.freeze({
    unit: "KAKAO_ADFIT_KO_HOME_FIRST_MOBILE_UNIT",
    width: "KAKAO_ADFIT_KO_HOME_FIRST_MOBILE_WIDTH",
    height: "KAKAO_ADFIT_KO_HOME_FIRST_MOBILE_HEIGHT",
  }),
  "ko-home-second-desktop": Object.freeze({
    unit: "KAKAO_ADFIT_KO_HOME_SECOND_DESKTOP_UNIT",
    width: "KAKAO_ADFIT_KO_HOME_SECOND_DESKTOP_WIDTH",
    height: "KAKAO_ADFIT_KO_HOME_SECOND_DESKTOP_HEIGHT",
  }),
  "ko-home-second-mobile": Object.freeze({
    unit: "KAKAO_ADFIT_KO_HOME_SECOND_MOBILE_UNIT",
    width: "KAKAO_ADFIT_KO_HOME_SECOND_MOBILE_WIDTH",
    height: "KAKAO_ADFIT_KO_HOME_SECOND_MOBILE_HEIGHT",
  }),
  "ko-article-first": Object.freeze({
    unit: "KAKAO_ADFIT_KO_ARTICLE_FIRST_UNIT",
    width: "KAKAO_ADFIT_KO_ARTICLE_FIRST_WIDTH",
    height: "KAKAO_ADFIT_KO_ARTICLE_FIRST_HEIGHT",
  }),
  "ko-article-second": Object.freeze({
    unit: "KAKAO_ADFIT_KO_ARTICLE_SECOND_UNIT",
    width: "KAKAO_ADFIT_KO_ARTICLE_SECOND_WIDTH",
    height: "KAKAO_ADFIT_KO_ARTICLE_SECOND_HEIGHT",
  }),
