...
test("Kakao AdFit replaces every active Coupang path without empty ads", async () => {
  ...
  assert.doesNotMatch(
    outputText,
    /coupang-partners-banner\.vercel\.app|AF8916827|data-coupang|coupang_banner_clicked|coupang-interlude/u,
  );
